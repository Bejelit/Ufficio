...
<div class="container">
    ...
    <div class="form-container">
        <form id = "modifica" method="POST" action="{{ route('update', $worker->matricola) }}">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <input type="text" name="nome" value={{$worker->nome}}>
            </div>
            <div class="form-group">
                <label for="cognome">Cognome:</label>
                <input type="text" name="cognome" value={{$worker->cognome}}>
            </div>
            <div class="form-group">
                <label for="ruolo">Ruolo:</label>
                <select name="ruolo">
                    <option name="ruolo">{{$worker->ruolo}}</option>
